...
extension QuestMapItem {
    ...
    static let questMap1: [QuestMapItem] = [
        ...
        QuestMapItem(orderIndex: 1, questType: .context),
        QuestMapItem(orderIndex: 2, questType: .guided),
        QuestMapItem(orderIndex: 3, questType: .newCategory),
        QuestMapItem(orderIndex: 4, questType: .context),
        QuestMapItem(orderIndex: 5, questType: .guided),
        QuestMapItem(orderIndex: 6, questType: .retro)
    ]
